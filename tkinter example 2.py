...
class MyGUI:
    def __init__(self):
        ...
        self.menubar.add_cascade(menu=self.actionmenu,label = "Actionmenu")
        ...
        self.button = tk.Button(self.root,text="Show message",command=self.show_message,font=("Arial",18))
